            ...
            <div className="md:col-span-5 p-6 md:p-8">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <motion.div
                  ...
                  className="mb-10"
                >
                  <h2 className="text-xl font-medium font-serif text-neutral-800 mb-4">Couple Details</h2>

                  <div className='flex items-center gap-6 mb-6'>
                    <div className="">
                      <h3 className="text-lg font-medium text-neutral-700 mb-3">Bride</h3>
                    ...
                    <div className="">
                      <h3 className="text-lg font-medium text-neutral-700 mb-3">Groom</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                ...
                <motion.div
                  ...
                  className="mb-10"
                >
                  <h2 className="text-xl font-medium font-serif text-neutral-800 mb-4">Event Details</h2>
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.2 }}
                >
                  <h2 className="text-xl font-medium font-serif text-neutral-800 mb-4">Additional Details</h2>
...
const TabButton: React.FC<TabButtonProps> = ({ active, onClick, icon, label }) => {
  return (
    <button
      type="button"
      className={`flex items-center px-4 py-3 border-b-2 transition-colors ${active
